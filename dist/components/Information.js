    ...
    return (React.createElement("div", { className: 'container' },
        React.createElement("div", { className: 'wrap_information' },
            React.createElement("div", { className: 'information_block1' },
                React.createElement("img", { src: block1, id: 'block1_img' }),
                ...
                React.createElement(NavLink, { to: '/business_in_switzerland', className: 'block1_more information_more' }, "More")),
            React.createElement("div", { className: 'information_block2' },
                React.createElement("img", { src: block2, id: 'block2_img' }),
                ...
                React.createElement(NavLink, { to: '/business_development', className: 'block2_more information_more' }, "More")),
            React.createElement("div", { className: 'information_block3' },
                React.createElement("img", { src: block3, id: 'block3_img' }),
                ...
                React.createElement(NavLink, { to: '/emtech_in_davos', className: 'block3_more information_more' }, "More")),
            React.createElement("div", { className: 'information_block4' },
                React.createElement("img", { src: block4, id: 'block4_img' }),
                ...
                React.createElement(NavLink, { to: '/investment_club_start', className: 'block4_more information_more' }, "More")))));
}
